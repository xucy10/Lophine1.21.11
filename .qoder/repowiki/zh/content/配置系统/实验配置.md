...
- [RedStoneConfig.java:14-34](file://lophine-server/src/main/java/fun/bm/lophine/config/modules/experiment/RedStoneConfig.java#L14-L34)
...
章节来源
- [RedStoneConfig.java:16-34](file://lophine-server/src/main/java/fun/bm/lophine/config/modules/experiment/RedStoneConfig.java#L16-L34)
...
RS["RedStoneConfig"] --> RP["Redstone 补丁(实验)"]
...
- 红石与命令
  - 红石行为差异影响更新频率；命令执行本身轻量，但 save-all 可能引发 I/O 峰值。
...
## 结论
实验配置模块为 Lophine 提供了可控的“试验场”，在不影响主线稳定性的前提下探索新行为与优化手段。建议以最小可行原则启用，结合监控与日志持续验证，并在验证成熟后迁移到正式模块。
